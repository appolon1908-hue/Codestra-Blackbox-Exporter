...
REQ={"codestra","moneybee","beyvra","breero","larim-a","transportation","booked4seasons","social","klyrow","telnexa","kyqra","restaurant","provisioning"}; HOST='blac.codestra.media'
...
if not d.get('probeClasses') or not d.get('features'): fail('probe classes/features must be defined')
if d.get('exposure')=='public_native': fail('native service may not be public')
print('Codestra enterprise profile validation PASS: '+os.environ.get('GITHUB_REPOSITORY','blackbox-exporter'))
